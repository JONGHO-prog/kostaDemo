...
public class Course implements Serializable {
	...
	@Id	
	@GeneratedValue(generator="COM_NAVIWORKS_ACME_COURCE_COURSE_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="COM_NAVIWORKS_ACME_COURCE_COURSE_ID_GENERATOR", strategy="native")	
	private long id;
	...
	@ManyToMany(targetEntity=com.naviworks.acme.cource.LearningObject.class)	
	...
	@OneToMany(mappedBy="course", targetEntity=com.naviworks.acme.clazz.Clazz.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
