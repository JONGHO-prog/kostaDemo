...
public class Venue implements Serializable {
	...
	@Id	
	@GeneratedValue(generator="COM_NAVIWORKS_ACME_CLAZZ_VENUE_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="COM_NAVIWORKS_ACME_CLAZZ_VENUE_ID_GENERATOR", strategy="native")	
	private long id;
	...
	@OneToMany(mappedBy="venue", targetEntity=com.naviworks.acme.clazz.ClazzDay.class)	
