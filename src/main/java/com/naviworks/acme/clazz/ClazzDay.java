...
public class ClazzDay implements Serializable {
	...
	@Id	
	@GeneratedValue(generator="COM_NAVIWORKS_ACME_CLAZZ_CLAZZDAY_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="COM_NAVIWORKS_ACME_CLAZZ_CLAZZDAY_ID_GENERATOR", strategy="native")	
	private long id;
	
	@ManyToOne(targetEntity=com.naviworks.acme.clazz.Venue.class, fetch=FetchType.LAZY)	
	...
	private com.naviworks.acme.clazz.Venue venue;
	
	@OneToOne(targetEntity=com.naviworks.acme.clazz.Clazz.class, fetch=FetchType.LAZY)	
	...
	private com.naviworks.acme.clazz.Clazz clazz;
	...
	@ManyToMany(targetEntity=com.naviworks.acme.sme.Instructor.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	...
	public void setClazz(com.naviworks.acme.clazz.Clazz value) {
		this.clazz = value;
	}
	
	public com.naviworks.acme.clazz.Clazz getClazz() {
		return clazz;
	}
	...
	public void setVenue(com.naviworks.acme.clazz.Venue value) {
		this.venue = value;
	}
	
	public com.naviworks.acme.clazz.Venue getVenue() {
		return venue;
	}
